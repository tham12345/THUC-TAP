...
<head>
    <title>Hoàn trả túi máu 1</title>
    <meta charset="utf-8">
...
<body>
        ...
        <div class="sidebar">
     <div class="logo"><a onclick="window.location.replace('xuatmautrongbenhvien')"><image  width="80px" height="50px;"  src="resources/image/logo-vnpt.png"></a></div>
        <nav>
            <ul>
                <li>
                            ...
                            <table class="form-table2">
                                <form name="formnhapthongtin2">
                                    <tr>
                                        ...
                                        <td class="inputstn">
                                            <input autofocus="autofocus" type="text" id="Sotiepnhan" list="sp"> </td>
                                ...
                                <table class="bangthong-tin" cellspacing="0" border="1 " cellpadding="2" id="tblNeedsScrolling">
                                    <thead>
                                        <tr id="tieudeban">
                                            ...
                                            <th>
                                                <p class="overflow-ellipsis">Người nhân</p>
                                            </th>
                                            <th>
                                                <p class="overflow-ellipsis">Người giao</p>
                                            </th>
                                            <th>
                                                <p class="overflow-ellipsis">Trang thai</p>
                                            </th>
                                            <th>
                                                <p class="overflow-ellipsis">So phiếu xuất</p>
                                            </th>
                                            <th>
